...
LLVM_BB_URL_BASE := https://github.com/JuliaBinaryWrappers/LLVM_full_assert_jll.jl/releases/download/LLVM_full_assert-v$(LLVM_VER)+$(LLVM_BB_REL)
LLVM_BB_NAME := LLVM_full_assert.v$(LLVM_VER)
endif
